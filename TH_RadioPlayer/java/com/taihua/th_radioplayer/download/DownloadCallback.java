...
public class DownloadCallback implements
    ...
    private WeakReference<DownloadHolder> viewHolderRef;
    private DownloadManager downloadManager;
    private boolean cancelled = false;
    private Cancelable cancelable;

    public DownloadCallback(DownloadHolder viewHolder) {
        this.switchViewHolder(viewHolder);
    }

    public boolean switchViewHolder(DownloadHolder viewHolder) {
        ...
        synchronized (DownloadCallback.class) {
            ...
            this.viewHolderRef = new WeakReference<DownloadHolder>(viewHolder);
        }
        return true;
    }
    ...
    private DownloadHolder getViewHolder() {
        if (viewHolderRef == null) return null;
        DownloadHolder viewHolder = viewHolderRef.get();
        if (viewHolder != null) {
    ...
    public void onWaiting() {
        ...
        DownloadHolder viewHolder = this.getViewHolder();
        if (viewHolder != null) {
